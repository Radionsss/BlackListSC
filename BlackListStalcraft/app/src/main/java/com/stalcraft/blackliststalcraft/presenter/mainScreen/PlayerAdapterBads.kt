...
class PlayerAdapterBads(private val context: Context, pref: SharedPreferences, requireActivity: FragmentActivity, resources: Resources) : BasePlayerAdapter(context, pref, requireActivity, resources) {
